<!DOCTYPE HTML>  
    <html>
        <head>
            ...
            <title>Validation Update Data - Fauzi Scholarship Website</title>
    ...
    ?>
        ...
        <?php
            ...
            if (empty($_POST["univ"])) {
                ...
                $univErr = "*Only letters and white space allowed (From University Field)";
                }else{
                    $univ = $_POST["univ"];
                }
            }
            ...
            && empty($webErr) && empty($sgErr)){
                ...
                $query = "UPDATE participant SET full_name='$name',gender='$gender',dob='$date'
                ,p_address='$add',email='$email',phone='$phone',university='$univ',university_web='$web',university_sg='$sg' WHERE participant_id = $id";
                ...
                $activity = "updated participant data name $name";
                //3. Save the data using the query
                $logquery = "
                ...
                ?>
                    <h2>Data has successfully updated</h2>
                    <br/>
